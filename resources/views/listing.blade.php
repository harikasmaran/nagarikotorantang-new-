    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h2 class="fw-bold">Peta desa</h2>
                    <br>
                    <div id="map" style="height: 500px; border: 2px solid #ccc; border-radius: 10px;"></div>
...
<script>
    ...
    var map = L.map('map').setView([-0.18078, 100.56634], 14);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
    }).addTo(map);
    L.marker([-0.18078, 100.56634]).addTo(map)
        .bindPopup('<b>Nagari Koto Rantang</b><br>Kecamatan Palupuh, Kabupaten Agam')
        .openPopup();
...
<!-- ini yg lama -->
<!-- <script>
    var map = L.map('map').setView([-0.225, 100.633], 14);
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
    }).addTo(map);
    L.marker([-0.225, 100.633]).addTo(map)
        .bindPopup('<b>Nagari Koto Rantang</b>')
        .openPopup();
</script> -->
@endpush
